...
exports.genre_delete_post = function (req, res, next) {
    async.parallel({
        ...
        if (results.genre_books.length > 0) {
            ...
            // No books. Delete object and redirect to the list of authors.
...
exports.genre_update_post = [
    ...
    body('name').trim().isLength({ min: 1, max: 100 }).escape().withMessage('Must input a valid genre name (max 100 chars).'),
